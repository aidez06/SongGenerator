...
from suno_api import schemas
from suno_api.client_api import generate_lyrics, generate_music, get_feed, get_lyrics, get_credits
from suno_api.deps import get_token
app = FastAPI(
    openapi_url="/openapi.json",  # This should be set or left as default
    docs_url="/docs",             # Ensure this is not None
    redoc_url="/redoc"            # Optional: URL for ReDoc
)
